...
const Chart = (props) => {
  ...
  const pixelFor = (dollar) => {
    const normalizedDollar = (dollar - chart_dims.dollar_low) / chart_dims.dollar_delta;
    return Math.abs(normalizedDollar * chart_dims.pixel_height - chart_dims.pixel_height);
};
